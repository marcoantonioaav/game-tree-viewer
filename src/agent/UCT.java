...
public class UCT extends AI
{
	...
	)
	{
		...
		final UCTNode root = new UCTNode(null, null, context);
	 ...
	 */
	public static UCTNode select(final UCTNode current)
	{
		if (!current.unexpandedMoves.isEmpty())
		{
			...
			return new UCTNode(current, move, context);
		}
        ...
        {
        	final UCTNode child = current.children.get(i);
	 ...
	 * @return
	 */
	public static Move finalMoveSelection(final UCTNode rootNode)
	{
		UCTNode bestChild = null;
        ...
        for (int i = 0; i < numChildren; ++i) 
        {
        	final UCTNode child = rootNode.children.get(i);
	...
	private static class UCTNode
	{
		...
		/** Child nodes */
		private final List<UCTNode> children = new ArrayList<UCTNode>();
		 ...
		 * @param context
		 */
		public UCTNode(final UCTNode parent, final Move moveFromParent, final Context context)
		{
			this.parent = parent;
        ...
        public Node toNode() {
            Node node = new Node(context, (int)scoreSums[0], visitCount);
